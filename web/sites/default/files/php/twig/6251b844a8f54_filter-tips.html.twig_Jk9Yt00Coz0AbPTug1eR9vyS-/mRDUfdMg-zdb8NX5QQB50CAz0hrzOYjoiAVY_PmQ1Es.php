...
class __TwigTemplate_ec1a4acf4259c0e3df5a5be8c0fe66ade5b1eda3c41e49a6b64992bb3d4ecd8b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/seven/templates/classy/content-edit/filter-tips.html.twig", "C:\\laragon\\www\\constructora-beltran\\web\\core\\themes\\seven\\templates\\classy\\content-edit\\filter-tips.html.twig");
    }
